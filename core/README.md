...
```python
from core.db import db_manager, get_db, init_db
from core.db.models import ModelMetadata
from core.db.enums import TaskType, ModelStatus
...
# 获取兼容的框架
from core.db.enums import get_compatible_frameworks
...
from core.db.enums import TaskType
from core.db.models import ModelMetadata, AuditLog
...
```python
from core.logging import get_request_id, set_request_id
from core.logging.context import set_request_id as set_context_id
...
from core.db.models import ModelMetadata
from core.ml import model_registry, model_loader, inference_engine
from core.experiment import ab_test_manager
...
```python
from core.ml.exceptions import ModelException
