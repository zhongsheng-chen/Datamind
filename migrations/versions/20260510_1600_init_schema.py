...
def upgrade() -> None:
    ...
    sa.Column('version', sa.String(length=50), nullable=False, comment='被分配到的模型版本'),
    sa.Column('user', sa.String(length=64), nullable=True, comment='用户标识，用于用户级追踪'),
    sa.Column('source', sa.String(length=20), nullable=False, comment='分配来源，可选值：routing / experiment / deployment'),
    sa.Column('strategy', sa.String(length=20), nullable=True, comment='分配策略，可选值：random / hash / weighted'),
    sa.Column('context', postgresql.JSONB(astext_type=sa.Text()), nullable=True, comment='分配上下文，如实验 ID、分组、权重等'),
    sa.Column('routed_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='路由分配时间'),
    ...
    sa.Column('source', sa.String(length=16), server_default=sa.text("'system'"), nullable=False, comment='来源类型，可选值：http / system'),
    ...
    sa.Column('user', sa.String(length=64), nullable=True, comment='操作者'),
    sa.Column('ip', sa.String(length=64), nullable=True, comment='操作者 IP 地址'),
    ...
    sa.Column('model_id', sa.String(length=64), nullable=False, comment='所属模型 ID'),
    sa.Column('version', sa.String(length=50), nullable=False, comment='部署的版本号'),
    sa.Column('framework', sa.String(length=50), nullable=False, comment='模型框架，可选值 sklearn / xgboost / lightgbm / catboost / torch / onnx / tensorflow'),
    ...
    sa.Column('description', sa.String(length=255), nullable=True, comment='部署说明'),
    sa.Column('id', sa.BigInteger(), autoincrement=True, nullable=False, comment='自增主键 ID'),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='创建时间'),
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='更新时间'),
    ...
    sa.Column('experiment_id', sa.String(length=64), nullable=False, comment='实验唯一标识'),
    sa.Column('model_id', sa.String(length=64), nullable=False, comment='所属模型 ID'),
    sa.Column('name', sa.String(length=100), nullable=False, comment='实验名称'),
    sa.Column('description', sa.String(length=255), nullable=True, comment='实验描述'),
    sa.Column('status', sa.String(length=20), server_default=sa.text("'running'"), nullable=False, comment='实验状态，可选值：running / paused / completed'),
    sa.Column('config', postgresql.JSONB(astext_type=sa.Text()), nullable=True, comment='实验配置，JSON 格式，包含策略、变体、权重等'),
    sa.Column('effective_from', sa.DateTime(timezone=True), nullable=True, comment='生效开始时间'),
    sa.Column('effective_to', sa.DateTime(timezone=True), nullable=True, comment='生效结束时间'),
    ...
    sa.Column('model_id', sa.String(length=64), nullable=False, comment='模型唯一标识'),
    ...
    sa.Column('framework', sa.String(length=50), nullable=False, comment='框架，可选值：sklearn / xgboost / lightgbm / catboost / torch / onnx / tensorflow'),
    ...
    sa.Column('model_id', sa.String(length=64), nullable=False, comment='所属模型 ID'),
    sa.Column('strategy', sa.String(length=20), nullable=False, comment='路由策略，可选值：random / consistent / bucket / round_robin / weighted'),
    sa.Column('config', postgresql.JSONB(astext_type=sa.Text()), nullable=True, comment='策略配置，JSON 格式，如权重、桶范围等'),
