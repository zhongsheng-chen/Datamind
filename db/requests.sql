...
COMMENT ON COLUMN requests.status IS '请求状态，表示请求的当前状态（completed, failed, processing）';
...
COMMENT ON COLUMN requests.response_time IS '请求处理时长，表示请求从开始到结束所花费的时间';
