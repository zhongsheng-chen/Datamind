...
from core.ml.exceptions import (
    ModelException, ModelNotFoundException, ModelAlreadyExistsException,
    ModelValidationException, ModelFileException
)
from core.logging import log_manager, get_request_id
from core.db.enums import TaskType, ModelType, Framework, ModelStatus
...
async def get_model_types(framework: Optional[str] = None):
    """获取模型类型列表"""
    from core.db.enums import get_compatible_model_types
